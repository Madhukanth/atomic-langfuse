...
import { VirtualizedObservationTree } from "./VirtualizedObservationTree";
...
import { VirtualizedTraceTimelineView } from "@/src/components/trace/VirtualizedTraceTimelineView";
...
export function Trace(props: {
  ...
  // Memoize setCurrentObservationId to prevent unnecessary re-renders in virtualized components
  ...
  // Use virtualized tree for large datasets (> 300 observations) to improve performance
  // Virtualization renders only visible items, significantly reducing DOM nodes and improving scroll performance
